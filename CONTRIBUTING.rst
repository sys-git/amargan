...
amargan could always use more documentation, whether as part of the
official amargan docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 2.6, 2.7, 3.5, 3.6 and for PyPy. Check
   https://travis-ci.org/sys-git/amargan/pull_requests
