...
The sources for amargan can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/sys-git/amargan
.. _tarball: https://github.com/sys-git/amargan/tarball/master
